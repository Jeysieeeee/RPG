...
Monster* Map::checkRandomEncounter() {
    ...
    if( roll <= 5 ) {
        ...
        monster = new Monster("Orc", 10, 8, 200, 5, 1,
            "Short Sword", 2, 7);
        ...
        monster = new Monster("Goblin", 6, 6, 100, 8, 0,
            "Dagger", 1, 5);
        ...
        monster = new Monster("Ogre", 20, 12, 500, 9,  2,
            "Club", 3, 8);
        ...
        monster = new Monster("Orc Lord", 25, 15, 2000, 10, 5,
